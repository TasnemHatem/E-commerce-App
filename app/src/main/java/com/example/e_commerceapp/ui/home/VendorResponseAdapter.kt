...
class VendorResponseAdapter (var brands:  VendorsResponse, private val clickBrandBtn: OnBrandClickListener) : RecyclerView.Adapter<VendorResponseAdapter.ViewHolder>(){
